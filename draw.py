...
def draw_line(x0, y0, x1, y1, screen, color):
    ...
    if dx > 0 and dy > 0 and dy <= dx:
        ...
        # 5th octant
        draw_line_case5(x0, y0, x1, y1, dx, dy, screen, color)
    elif dx <= 0 and dy < 0 and -dy > -dx:
        # 6th octant
        ...
        # 8th octant
        draw_line_case8(x0, y0, x1, y1, dx, dy, screen, color)

def draw_line_case8(x0, y0, x1, y1, dx, dy, screen, color):
    a = dy
    b = -dx
...
def draw_line_case5(x0, y0, x1, y1, dx, dy, screen, color):
    a = dy
    b = -dx
